...
frappe.ui.form.on("Leave Adjustment Scheduler", {
    ...
    async refresh(frm) {
        ...
        if (!frm.doc.workflow_exist)
        {
            ...
            await frappe.call({
                method: "sowaan_hr.sowaan_hr.sowaan_hr.api.api.check_work_flow_exist",
                args: {
            ...
            if (work_flow_doc_name) 
                {
                    await frappe.call({
                        method: "sowaan_hr.sowaan_hr.sowaan_hr.api.api.get_workflow_states",
                        args: {
