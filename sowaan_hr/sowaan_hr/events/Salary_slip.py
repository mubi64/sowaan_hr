...
def loan_withdrawal(self, method):
    if self.loan_product and self.loan_amount:
        ...
        fund_contribution_name = frappe.get_list("Fund Contribution", filters={"fund_setting": fund_setting_name[0].name , "employee": self.applicant, "start_date": ["<=", self.posting_date]})
